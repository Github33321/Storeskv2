...
// можно оставить иконки тут, если квадраты нужны по всему сайту
function IconChip(props){ return (
    <svg viewBox="0 0 24 24" width="28" height="28" fill="none" {...props}>
        <path d="M9 3h6v2h2a2 2 0 0 1 2 2v2h2v6h-2v2a2 2 0 0 1-2 2h-2v2H9v-2H7a2 2 0 0 1-2-2v-2H3V9h2V7a2 2 0 0 1 2-2h2V3Z" stroke="currentColor" strokeWidth="1.6"/>
        <path d="M9 9h6v6H9V9Z" stroke="currentColor" strokeWidth="1.6"/>
    </svg>
);}
function IconPhone(props){ return (
    <svg viewBox="0 0 24 24" width="28" height="28" fill="none" {...props}>
        <path d="M9 2h6a2 2 0 0 1 2 2v16a2 2 0 0 1-2 2H9a2 2 0 0 1-2-2V4a2 2 0 0 1 2-2Z" stroke="currentColor" strokeWidth="1.6"/>
...
function IconHeadset(props){ return (
    <svg viewBox="0 0 24 24" width="28" height="28" fill="none" {...props}>
        <path d="M4 13v3a3 3 0 0 0 3 3h1v-8H7a3 3 0 0 0-3 3Z" stroke="currentColor" strokeWidth="1.6"/>
        <path d="M20 13v3a3 3 0 0 1-3 3h-1v-8h1a3 3 0 0 1 3 3Z" stroke="currentColor" strokeWidth="1.6"/>
        <path d="M4 13a8 8 0 0 1 16 0" stroke="currentColor" strokeWidth="1.6" strokeLinecap="round"/>
    </svg>
);}
function IconLaptop(props){ return (
    <svg viewBox="0 0 24 24" width="28" height="28" fill="none" {...props}>
...
function IconBolt(props){ return (
    <svg viewBox="0 0 24 24" width="28" height="28" fill="none" {...props}>
...
export default function AppLayout(){
    return (
        <div className="steamPage">
            ...
            {/* если квадраты по всему сайту нужны — оставляем */}
            ...
            <div className="steamFrame">
                {/* ВАЖНО: чтобы твой .home padding работал, но и другие страницы тоже */}
